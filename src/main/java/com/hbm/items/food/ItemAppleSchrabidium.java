		...
		if (!world.isRemote) {
			...
			if(stack.getItem() == ModItems.apple_schrabidium) {
				...
				if (stack.getItemDamage() == 1) {
					...
					// EAT ASS    player.addPotionEffect(new PotionEffect(Potion.field_76443_y.id, 1200, 9));
				}
				...
				if (stack.getItemDamage() == 2) {
					...
					// EAT ASS    player.addPotionEffect(new PotionEffect(Potion.field_76443_y.id, 2147483647, 99));
				}
			}
